...
class Mavi extends StatefulWidget {
  const Mavi({super.key});

  @override
  State<Mavi> createState() => _MaviState();
}
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        "https://drive.google.com/uc?export=view&id=1lj-TOeecUFV--4IDcFLurV336i_hxyB3",
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => const Lacivert(),
