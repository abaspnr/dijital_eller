...
class Lacivert extends StatefulWidget {
  const Lacivert({super.key});

  @override
  State<Lacivert> createState() => _LacivertState();
}

class _LacivertState extends State<Lacivert> {
  @override
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        "https://drive.google.com/uc?export=view&id=1bg06MLXFdx_FMb2OKiuJ-t2RZg-TF4DA",
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              transitionDuration:
                                  const Duration(milliseconds: 300),
                              pageBuilder: (_, __, ___) => const Mavi(),
                              transitionsBuilder: (_, animation, __, child) {
                                return FadeTransition(
                                  opacity: animation,
                                  child: child,
