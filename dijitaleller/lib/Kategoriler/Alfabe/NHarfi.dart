...
class NHarfi extends StatefulWidget {
  const NHarfi({super.key});

  @override
  State<NHarfi> createState() => _NHarfiState();
}
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        "https://drive.google.com/uc?export=view&id=1rjnXtHfqIFr4lY38Xm6IjcSDWuSP6Hxn",
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => const MHarfi(),
