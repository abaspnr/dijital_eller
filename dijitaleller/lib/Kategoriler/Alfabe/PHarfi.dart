...
class PHarfi extends StatefulWidget {
  const PHarfi({super.key});

  @override
  State<PHarfi> createState() => _PHarfiState();
}
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        "https://drive.google.com/uc?export=view&id=1FTySPluJ-DPpIOy-PDq7IveOGnUOKR0a",
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => const O2Harfi(),
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              transitionDuration:
                                  const Duration(milliseconds: 300),
                              pageBuilder: (_, __, ___) => const RHarfi(),
                              transitionsBuilder: (_, animation, __, child) {
                                return FadeTransition(
                                  opacity: animation,
                                  child: child,
