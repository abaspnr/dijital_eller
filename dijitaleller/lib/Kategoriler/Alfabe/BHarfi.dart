...
class BHarfi extends StatefulWidget {
  const BHarfi({super.key});

  @override
  State<BHarfi> createState() => _BHarfiState();
}
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        "https://storage.googleapis.com/dijital-eller-gifler/abi%20(5).gif",
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => const AHarfi(),
