...
class C2Harfi extends StatefulWidget {
  const C2Harfi({super.key});

  @override
  State<C2Harfi> createState() => _C2HarfiState();
}

class _C2HarfiState extends State<C2Harfi> {
  @override
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => const CHarfi(),
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              transitionDuration:
                                  const Duration(milliseconds: 300),
                              pageBuilder: (_, __, ___) => const DHarfi(),
                              transitionsBuilder: (_, animation, __, child) {
                                return FadeTransition(
                                  opacity: animation,
                                  child: child,
