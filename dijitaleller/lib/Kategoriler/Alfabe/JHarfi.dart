...
class JHarfi extends StatefulWidget {
  const JHarfi({super.key});

  @override
  State<JHarfi> createState() => _JHarfiState();
}
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        "https://drive.google.com/uc?export=view&id=1z8ael-RcGWi5bCEg8I2TmmNVPxqvxHwg",
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => const i2Harfi(),
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              transitionDuration:
                                  const Duration(milliseconds: 300),
                              pageBuilder: (_, __, ___) => const KHarfi(),
                              transitionsBuilder: (_, animation, __, child) {
                                return FadeTransition(
                                  opacity: animation,
                                  child: child,
