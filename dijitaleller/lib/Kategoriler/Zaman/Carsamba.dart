...
class Carsamba extends StatefulWidget {
  const Carsamba({super.key});

  @override
  State<Carsamba> createState() => _CarsambaState();
}
          ...
          child: Column(
            children: [
              Container(
                ...
                child: ClipRRect(
                    borderRadius: BorderRadius.circular(20),
                    child: GifDisplayWidget(gifKey: "gif2")),
              ),
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => const Sali(),
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              transitionDuration:
                                  const Duration(milliseconds: 300),
                              pageBuilder: (_, __, ___) => const Persembe(),
                              transitionsBuilder: (_, animation, __, child) {
                                return FadeTransition(
                                  opacity: animation,
                                  child: child,
