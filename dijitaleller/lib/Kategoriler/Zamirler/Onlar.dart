...
class Onlar extends StatefulWidget {
  const Onlar({super.key});

  @override
  State<Onlar> createState() => _OnlarState();
}

class _OnlarState extends State<Onlar> {
  @override
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        "https://drive.google.com/uc?export=view&id=1coJEtSF35KeBWAwhRWPmyXCBs_SFwEVg",
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => const Ona(),
