...
class Onun extends StatefulWidget {
  const Onun({super.key});

  @override
  State<Onun> createState() => _OnunState();
}

class _OnunState extends State<Onun> {
  @override
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    imageUrl:
                        "https://drive.google.com/uc?export=view&id=1Nk5PV1ZIW1ixewFi2VUe3CWq6VQ8Cul4",
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              transitionDuration:
                                  const Duration(milliseconds: 300),
                              pageBuilder: (_, __, ___) => const Bana(),
                              transitionsBuilder: (_, animation, __, child) {
                                return FadeTransition(
                                  opacity: animation,
                                  child: child,
